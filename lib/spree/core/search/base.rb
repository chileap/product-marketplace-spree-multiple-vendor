module Spree
  module Core
    module Search
      class Base
        attr_accessor :properties, :current_user, :current_currency, :current_store, :taxon, :current_vendor, :show_discontinued
        ...
        def initialize(params)
          ...
          @taxon = params[:taxon]
          @current_vendor = params[:current_vendor]
          @show_discontinued = params[:show_discontinued]
        ...
        def extended_base_scope
          ...
          base_scope = base_scope.where(vendor_id: current_vendor.id) if current_vendor.present?
